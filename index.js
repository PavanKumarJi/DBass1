...
db.human.find({salary:{$gt:"30000"}}).pretty()
{
        "_id" : ObjectId("62e1445a6cbac12b436a7ded"),
        "firstName" : "Jame",
        "lastName" : "Doe",
...
> db.human.find({overallExp:{$gt:"2"}})
> db.human.find({yearGrad:{$gt:"2015"},overallExp:{$gt:"1"}}).pretty()
{
        "_id" : ObjectId("62e1445a6cbac12b436a7deb"),
        "firstName" : "John",
        "lastName" : "Doe",
...
> db.human.updateMany({salary:{$gt:"70000"}},{$set:{salary:"60000"}})
{ "acknowledged" : true, "matchedCount" : 0, "modifiedCount" : 0 }
> db.human.deleteMany({lastCompany:"Y"})
